...
def generate_general_excel(selected_df, hide_client_group=False):
    ...
    for g in groups:
        ...
        dyn_cols = []
        for y in report_years:
            dyn_cols.extend([f"FY{y} Fee Paid By", f"FY{y} Fee Paid Date", f"FY{y} AFR Fee Paid By", f"FY{y} AFR Fee Paid Date", f"FY{y} AR/AFR Filed Date", f"FY{y} AR/AFR Status", f"FY{y} ES Fee Paid By", f"FY{y} ES Fee Paid Date", f"FY{y} ES Filed Date", f"FY{y} ES Status"])
                        ...
                        if ca2.button("🚀 Generate Report", use_container_width=True, key="btn_gen2"):
                            with st.spinner("Generating... Please wait..."):
                                ...
                                if "Internal Export - PDF" in exp_opt2:
                                    ...
                                    st.session_state.Sorry, something went wrong. Please try your request again.
